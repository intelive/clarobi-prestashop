					...
					<tr>
						<th>
							<span class="title_box  active">'
                                . $this->trans('Product id', array(), 'Admin.Global') . '</span>
						</th>
						<th>
							<span class="title_box  active">'
                                . $this->trans('Total adds to cart', array(), 'Admin.Global') . '</span>
						</th>
						<th>
							<span class="title_box  active">'
                                . $this->trans('Total views', array(), 'Admin.Global') . '</span>
						</th>
						<th>
							<span class="title_box  active">'
                                . $this->trans('Date add', array(), 'Admin.Global') . '</span>
						</th>
						<th>
							<span class="title_box  active">'
                                . $this->trans('Date update', array(), 'Admin.Global') . '</span>
						</th>
					</tr>
				</thead>
				<tbody>';
